...
export default class Rpc
{
  ...
  notification(method, ...params)
  {
    ...
    if(this.#logMessages) console.debug('notification:', notification)
  ...
  {
    if(this.#logMessages) console.debug('onMessage:', ...args)

    const message = this._onMessage ? (await this._onMessage(...args)) : args[0]
    ...
    if(reply !== undefined) return this.#stringify(reply)
  }
  ...
  request(method, ...params)
  {
    ...
    if(this.#logMessages) console.debug('request:', request)
  ...
  #stringify(data)
  {
    ...
    if(this.#logMessages) console.debug('    reply:', result)
