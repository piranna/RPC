...
export default class Rpc
{
  ...
  _decode({ack, error, id, method, params, result})
  {
    return {ack, error, id, method, params, result}
  }
  ...
  #onMessage = async message =>
  {
    ...
    // Decode message
    let {ack, error, id, method, params, result} = await this._decode(message)

    // Validate decoded message (no method nor ACK -> invalid response)
